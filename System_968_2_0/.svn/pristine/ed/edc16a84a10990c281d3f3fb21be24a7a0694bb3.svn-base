...
namespace Ac968.SystemModuleSetMeal.Utility.Alipay
{
    ...
    public class Service
    {
        ...
        public Service(string type)
        {
            ...
            cf.Type = _type = type;
            _partner = cf.Partner.Trim();
            _input_charset = cf.Input_charset.Trim().ToLower();
            _seller_email = cf.Seller_email.Trim();
            _return_url = cf.Return_url.Trim();
            _notify_url = cf.Notify_url.Trim();
        }
        ...
        public string Create_direct_pay_by_user(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //构造表单提交HTML数据
            strHtml =new  Submit(_type).BuildFormHtml(sParaTemp, GATEWAY_NEW, "get", strButtonValue);
        ...
        public string Query_timestamp()
        {
            ...
            string url = GATEWAY_NEW + "service=query_timestamp&partner=" + cf.Partner;
            string encrypt_key = "";
